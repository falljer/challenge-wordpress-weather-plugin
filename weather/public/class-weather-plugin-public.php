 ...
 * @subpackage JF_Weather_Plugin/public
 * @author     Jeremy Fall <falljer@gmail.com>
 */
class JF_Weather_Plugin_Public {
	 ...
	 * @return string
	 */
	public function weather_shortcode($args, $content = null) {
		$attributes = shortcode_atts( array(
			'field' => 'button'
		), $args );
		$field = $attributes['field'];
		$weather = JF_Weather_Plugin_Service::current_weather();

		return ($weather && $weather->current && $weather->current->{$field}) ? $weather->current->{$field} : 'Error';
	}
